...
async def main():
    try:
        ...
        print("---------------------------------- machine setup ...")
        machine = MittensMachineMotion(osap, system_interpolation_interval, system_twin_to_real_ms, extents = machine_extents)
        await machine.begin()
