...
# gear ratio is 1:4, so 90 degrees of actuator angle for each motor rev, 
theta_rpu = 1 / 90 
...
class MianaMotion:
    ...
    def system_graph(self, time: int):
        ...
        actu_pts = [(theta_shoulder) * theta_rpu, - (theta_elbow) * theta_rpu, axes_pt[2]] 
