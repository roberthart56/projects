'''
esp32_adxl343_espnow02.py

program to send position and color in four channels
to esp32 with pixel strip with Num_pix pixels.

position: 0 - Num_pix
colors: 0-255 in r,g,b using color map.
