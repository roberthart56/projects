...
# r_led = Pin(6, Pin.OUT)
# r_led(0)
pwm_r = PWM(Pin(2))  # create PWM object from a pin
pwm_g = PWM(Pin(3))  # create PWM object from a pin
pwm_b = PWM(Pin(4))  # create PWM object from a pin
...
# Initialize SPI.  Follow pinout for esp32.  Exposed pins are as follows and use SPI0.
spi = machine.SPI(1,
                  baudrate=1000000,
                  polarity=1,
                  phase=1,
...
#     #print(acc_x)
#     pwm_r.duty_u16(65535-acc_x*acc_x)  # set duty cycle, range 0-65535
#     pwm_g.duty_u16(65535-acc_y*acc_y)  # set duty cycle, range 0-65535
#     pwm_b.duty_u16(65535-acc_z*acc_z)  # set duty cycle, range 0-65535
