...
//in 10, add a read function of the same sort, or add a read buffer to the write function.
...
void SPI_read(unsigned char command,unsigned char bytes,unsigned char *read_buffer)
